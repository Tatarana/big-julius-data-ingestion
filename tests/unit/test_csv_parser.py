...
VALID_CSV = b"amount|date|description|installments|category\n100.50|2024-01-15|Supermarket|1/1|Food\n-50.00|2024-01-16|Gas station|2/4|Transport\n"
EMPTY_CSV = b""
WHITESPACE_CSV = b"   "
MISSING_COLUMNS_CSV = b"amount|date\n100.50|2024-01-15\n"
MALFORMED_ROW_CSV = b"amount|date|description|installments|category\nnot_a_number|2024-01-15|desc|1/1|cat\n150.00|2024-01-16|valid desc|1/2|cat\n"
EMPTY_ROWS_CSV = b"amount|date|description|installments|category\n"
BOM_CSV = b"\xef\xbb\xbfamount|date|description|installments|category\n75.00|2024-01-20|Coffee|1/1|Food\n"
COMMA_DECIMAL_CSV = b"amount|date|description|installments|category\n1.234,56|2024-01-10|desc|1/1|cat\n"
